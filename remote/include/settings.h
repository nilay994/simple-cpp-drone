...
#define WAYPOINT_THRESHOLD 0
#define CLOSE_TO_GATE_THRESHOLD 2.2 // this is related to yaw command and snakegate.. mostly yaw towards next waypoint? TODO: improve this comment
